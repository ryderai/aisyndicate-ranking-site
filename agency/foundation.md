...
- **PASS — Team named on their own site** (not scored). Ross Simmonds (Founder & CEO) on /leadership-team/. Not on /about.
- **FAIL — Case studies name the client** (not scored). Case studies are anonymised by industry, for example "a Construction Tech Leader". Client logos appear on the homepage with no results attached to them.
- **PASS — Case studies carry a number** (not scored). "107% Year-Over-Year Blog Growth"; "$228K annual organic revenue".
- **FAIL — You can buy without a sales call** (not scored). "Book a Call", "TALK TO A STRATEGIST" and "I Want a Proposal" all route to /contact/.
