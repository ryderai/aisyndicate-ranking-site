...
- **FAIL — Prices published** (not scored). No figure published. Dollar and percentage figures on site are client results.
- **PASS — Team named on their own site** (not scored). Jeffrey Herzog (CEO) and three more leaders on /about-us/.
- **PASS — Case studies name the client** (not scored). Kind Patches, Dave, Cocokind, Better named on /case-studies/.
- **PASS — Case studies carry a number** (not scored). Kind Patches: "175% Growth in 90 Days".
- **FAIL — You can buy without a sales call** (not scored). "Get Started" and "Request AI Visibility Audit" both open on-page lead forms. There is no pricing page at all.
