...
- **PASS — Prices published** (not scored). Six published tiers on /pricing/: Foundation $3,000, Growth $5,000, Accelerate $7,000, Scale $10,000, Command $12,000, Total Market $15,000 per month.
- **PASS — Team named on their own site** (not scored). Alex Boyd (Founder), Rocky Pedden (President), Ken Marshall (Chief Growth Officer) on /about/.
- **PASS — Case studies name the client** (not scored). 13 case studies including Expensify.
- **PASS — Case studies carry a number** (not scored). Expensify: "Increased SEO Sourced Product Sign Ups By 50% In 6 Months".
- **FAIL — You can buy without a sales call** (not scored). All six published tiers end in "Book An Intro Call", and the page says pricing is "completely customizable".
