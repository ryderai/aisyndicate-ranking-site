...
- **FAIL — Prices published** (not scored). /pricing/ is a 404. The homepage explains pricing models in general terms but gives no figure for their own work.
- **PASS — Team named on their own site** (not scored). Sam Yadegar (CEO), Rambod Yadegar (President) and 80 or more staff on /about-us/.
- **PASS — Case studies name the client** (not scored). Esqueleto named on /case-studies/.
- **PASS — Case studies carry a number** (not scored). Esqueleto: "Organic Revenue Increase More Than 43%".
- **FAIL — You can buy without a sales call** (not scored). "FREE CONSULT", "Free Consultation" and "Free Marketing Scorecard" all route to /contact-us/.
