...
- **PASS — Prices published** (not scored). Published tiers on /pricing/: Guide $1,850+, Summit $5,450+, Ascent $6,500. Add-ons: content $1,500+, Reddit visibility $2,500+, dashboards $5,000+.
- **PASS — Team named on their own site** (not scored). 21 named staff on /about/, including founder Mike Nierengarten and a director whose title is "SEO/GEO".
- **PASS — Case studies name the client** (not scored). Gainsight named on /case-studies/.
- **PASS — Case studies carry a number** (not scored). Gainsight: "Increases Leads 1,000 Percent, Lowers Cost per Lead by 62 Percent".
- **FAIL — You can buy without a sales call** (not scored). Every plan's "Get started" button routes to a contact form ending in "Submit".
