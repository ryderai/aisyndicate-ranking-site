...
- **PASS — Team named on their own site** (not scored). Rick Tousseyn and Stefanie Janssen, both co-founders, on /about. His title is Head of GEO/SEO.
- **PASS — Case studies name the client** (not scored). The Ocean Cleanup, Otterly.ai, Caliber and others named.
- **FAIL — Case studies carry a number** (not scored). Results are described in words rather than figures — "First Verified Donations from AI Search Platforms".
- **FAIL — You can buy without a sales call** (not scored). "Start Ranking Today" reads like a buy button but resolves to /contact, which offers a 15-minute call.
