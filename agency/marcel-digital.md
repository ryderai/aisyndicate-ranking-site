...
- **FAIL — Prices published** (not scored). No figure published; visitors are directed to contact.
- **PASS — Team named on their own site** (not scored). Ben Swartz (Founder + CEO) on /about.
- **PASS — Case studies name the client** (not scored). SEKO Logistics and Medius named.
- **PASS — Case studies carry a number** (not scored). SEKO Logistics: "49% Increase in New Business Inquiries".
- **FAIL — You can buy without a sales call** (not scored). "Get in touch", "Speak to an Expert" and "Let's talk" all route to /contact. The only other offer is a gated download.
