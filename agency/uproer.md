...
- **PASS — Team named on their own site** (not scored). Griffin Roer (Founder & CEO) and Dave Sewich on /about/.
- **PASS — Case studies name the client** (not scored). Thread Logic, Branch Basics, Evereve, IFTTT named.
- **PASS — Case studies carry a number** (not scored). Thread Logic: organic revenue up 1,065%.
- **FAIL — You can buy without a sales call** (not scored). "Let's Talk" and "Book An Intro" both lead to a form ending in "Submit", with the copy "We like to start with a 30-minute introductory call".
