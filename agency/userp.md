...
- **PASS — Prices published** (not scored). Published on /pricing/: Launch $5,500/mo, Accelerate $10,000/mo, Dominate $15,000/mo.
- **PASS — Team named on their own site** (not scored). Jeremy Moser (Co-founder, CEO) and others on /about-us/. The sitemap carries 45 team-member pages.
- **PASS — Case studies name the client** (not scored). monday.com and Nav named.
- **PASS — Case studies carry a number** (not scored). monday.com: organic traffic up 22% in three months, 77.84% overall.
- **FAIL — You can buy without a sales call** (not scored). "Work With Us", "Book Intro Call" and "Request AEO Pricing" all point to /start/.
