...
- **FAIL — Prices published** (not scored). /pricing/ is a 404 and the sitemap contains no pricing or cost URL.
- **PASS — Team named on their own site** (not scored). Evan Bailyn has his own page, though no job title is stated on it.
- **PASS — Case studies name the client** (not scored). Cadence Design Systems and iGPS named on /case-studies/.
- **PASS — Case studies carry a number** (not scored). Cadence: "934% increase in total keyword rankings".
- **FAIL — You can buy without a sales call** (not scored). The only paths are a contact form and a phone number.
