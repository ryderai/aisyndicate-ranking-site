...
- **FAIL — Prices published** (not scored). No figure published. Dollar figures on site are client results.
- **PASS — Team named on their own site** (not scored). Marc Blumberg (CEO) and three more on /about/.
- **PASS — Case studies name the client** (not scored). Blackbaud, Tuscany Pavers, Sticker Mountain named.
- **PASS — Case studies carry a number** (not scored). Blackbaud: "$22M increase in revenue".
- **FAIL — You can buy without a sales call** (not scored). "Book a Strategy Session", "Talk to a GEO Expert" and "Get Your Free GEO Audit" all go to /lets-talk/. The free audit is a form promising results in 24 hours plus a strategist call.
